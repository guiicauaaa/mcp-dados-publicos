...
public static class SystemPrompt
{
    ...
    /// The source line is printed by the client, from the tool result. The trailing blank line keeps the text
    ...
    public static string Build(DateTimeOffset nowBrasilia, string model) => $"""
        ...
        Regras:
        1. Consulte a ferramenta somente quando a pergunta pedir valores ou parlamentares de emendas Pix de um município. Se esses dados já estiverem na conversa, responda com eles. Para qualquer outra mensagem, responda normalmente.
